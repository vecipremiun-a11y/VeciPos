                                ...
                                <tr key={product.id} className="hover:bg-white/5 transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        {product.image ? (
                                            ...
                                            <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-xs text-gray-500">
                                                Img
                                            </div>
                                        )}
                                    </td>
                                    <td className="px-6 py-4">
                                        <span className="px-2 py-1 rounded-full text-xs font-semibold bg-[var(--color-primary)]/10 text-[var(--color-primary)] border border-[var(--color-primary)]/20">
                                            {product.category}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 text-gray-400 font-mono text-xs">{product.sku}</td>
                                    <td className="px-6 py-4 text-white font-bold">${product.price.toFixed(2)}</td>
                                    <td className="px-6 py-4 text-gray-400">${(product.cost || 0).toFixed(2)}</td>
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        {(() => {
                                            ...
                                            if (cost <= 0) return <span className="text-gray-500">-</span>;
                                            ...
                                            return (
                                                <div className="flex flex-col">
                                                    <span className={cn("font-bold text-xs", margin > 0 ? "text-green-400" : "text-red-400")}>
                                                        {margin.toFixed(1)}%
                                                    </span>
